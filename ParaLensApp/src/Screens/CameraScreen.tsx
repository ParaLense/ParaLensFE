...
import { Box, Button, Heading, VStack, Text as GluestackText } from '@gluestack-ui/themed';
      ...
      <Box flex={1} bg="$backgroundDark950">
        ...
        <Box position="absolute" top={24} left={20}>
          <Button size="sm" variant="solid" action="secondary" onPress={() => setSelectedMenu(null)}>
            <GluestackText color="$textLight50" textTransform="capitalize">{selectedMenu} · Ändern</GluestackText>
          </Button>
        </Box>
